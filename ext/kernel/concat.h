...
#define ZEPHIR_CONCAT_SVVVVVVVVV(result, op1, op2, op3, op4, op5, op6, op7, op8, op9, op10) \
	 zephir_concat_svvvvvvvvv(&result, op1, sizeof(op1)-1, op2, op3, op4, op5, op6, op7, op8, op9, op10, 0 TSRMLS_CC);
#define ZEPHIR_SCONCAT_SVVVVVVVVV(result, op1, op2, op3, op4, op5, op6, op7, op8, op9, op10) \
	 zephir_concat_svvvvvvvvv(&result, op1, sizeof(op1)-1, op2, op3, op4, op5, op6, op7, op8, op9, op10, 1 TSRMLS_CC);
